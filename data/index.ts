...
export const banners = [
  {
    ...
    classnameprop:
      "absolute top-1/2 left-0 transform -translate-y-1/2 text-white md:text-2xl text-xs sm:text-base font-extralight text-wrap md:w-[30vw] w-[75vw] pl-4 break-normal ml-10",
  },
  {
    src: "/banner2.png",
    content:
